...
fn day11(c: &mut Criterion) {
    c.bench_function("day11 part1", |b| b.iter(||
        day11::Day11
            .part1(black_box(include_str!("../inputs/11.txt")))
    ));
    c.bench_function("day11 part2", |b| b.iter(||
        day11::Day11
            .part2(black_box(include_str!("../inputs/11.txt")))
    ));
}
